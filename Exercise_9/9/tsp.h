...
class TSP {
    public:
        TSP(){
          ...
          /* register mutations */
          mutations.push_back(std::bind(&TSP::mutation_perm, this, std::placeholders::_1));
          mutations.push_back(std::bind(&TSP::mutation_shift, this, std::placeholders::_1));
          mutations.push_back(std::bind(&TSP::mutation_swap, this, std::placeholders::_1));
          mutations.push_back(std::bind(&TSP::mutation_inversion, this, std::placeholders::_1));
